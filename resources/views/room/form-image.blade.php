                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($room_galleries as $room_gallery)
                                                ...
                                                <div class="col-md-3 col-sm-3 m-2 p-0">                                                  
                                                    <img src="{{ url(getFullImagePath($id, $room_gallery->image_name)) }}" class="preview-img mb-2" style="height: 100px;"/>                                                   
                                                    <div>
                                                        <a href="{{ url('/backend/room/image/edit/room') }}/{{ $id }}/gallery/{{ $room_gallery->id }}/thumb/{{ $thumb }}" class="btn btn-sm px-3 btn-secondary">Edit</a>                                                
                                                        @if ($count != 1)
                                                            <a href="{{ url('/backend/room/image/delete/room') }}/{{ $id }}/gallery/{{ $room_gallery->id }}" class="btn btn-sm btn-danger" onclick="return confirm('Are your Sure to Delete?')">Delete</a>                                                                                        
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach                                          
