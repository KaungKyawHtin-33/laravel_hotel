...
@section('content')
<div ng-app="myApp" ng-cotroller="myCtrl">
    ...
    <section class="ftco-section ftco-no-pb ftco-room">
    	<div class="container-fluid px-0">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
    		...
    		<div class="row no-gutters" id="room-wrapper">
        ...
        $.ajax({
          ...
          success  : function(response) {
            ...
            for (let i = 0; i <script data.length; i++) {
              const room_name  = data[i].name   
              const room_price = data[i].price
              const room_id    = data[i].id
              const thumbnail  = 'http://localhost:8000/upload/' + room_id + '/thumb/' + data[i].thumbnail
                  ...
                  <div class="room-wrap d-md-flex">
                    ...
                    <div class="half d-flex align-items-center">
                      <div class="text p-4 text-center">
                        ...
                        <p class="mb-0"><span class="price mr-1"> ${room_price} </span> <span class="per">per night</span></p>
                        <h3 class="mb-3"><a href=" "> ${room_name} </a></h3>
