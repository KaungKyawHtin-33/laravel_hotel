...
/** This style use in Real world project */
...
Route::group(['prefix' => 'backend', 'middleware' => ['administrator:Admin']], function() {
    ...
    Route::prefix('room')->group(function() {
        ...
        Route::get('/image/edit/room/{room_id}/gallery/{gallery_id}/thumb/{thumb}', [RoomController::class, 'editImage']);
        Route::post('/image/update', [RoomController::class, 'updateImage']);
        Route::get('/image/delete/room/{room_id}/gallery/{gallery_id}', [RoomController::class, 'deleteImage']);
    });
